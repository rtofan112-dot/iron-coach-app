...
class Program {
    ...
    static async Task Run() {
        string profileDir = Path.Combine(Environment.CurrentDirectory, "temp_cdp_profile_v292_fix3");
        ...
        using (HttpClient client = new HttpClient()) {
            ...
            using (ClientWebSocket ws = new ClientWebSocket()) {
                ...
                string enableRuntime = "{\"id\":1,\"method\":\"Runtime.enable\"}";
                string enableLog = "{\"id\":2,\"method\":\"Log.enable\"}";
                ...
                try {
                    while (!cts.IsCancellationRequested) {
                        ...
                        if (msg.Contains("exceptionThrown") || msg.Contains("Error") || msg.Contains("Syntax")) {
