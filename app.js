...
function getExerciseDiagramSVG(exName, muscleGroup) {
  ...
  // 26.4.1 СГИБАНИЯ НА БИЦЕПС НА НАКЛОННОЙ СКАМЬЕ (45°)
  if ((n.includes("наклонн") || n.includes("45°")) && (n.includes("бицепс") || n.includes("гантел"))) {
    return `
      <svg class="w-full h-24" viewBox="0 0 260 90" fill="none" xmlns="http://www.w3.org/2000/svg">
        <!-- Наклонная спинка 45 градусов -->
        <line x1="35" y1="75" x2="90" y2="28" stroke="#475569" stroke-width="4.5" stroke-linecap="round"/>
        <line x1="90" y1="28" x2="115" y2="28" stroke="#334155" stroke-width="3"/>
        <line x1="35" y1="75" x2="65" y2="75" stroke="#475569" stroke-width="4"/>
        
        <!-- Атлет полулежа на наклонной скамье -->
        <circle cx="85" cy="24" r="6" stroke="#cbd5e1" stroke-width="2"/>
        <line x1="82" y1="29" x2="48" y2="60" stroke="#f1f5f9" stroke-width="4"/>
        <polyline points="48,60 55,75 55,85" stroke="#94a3b8" stroke-width="3"/>
        
        <!-- Рука отведена назад за корпус с мощным растяжением длинной головки -->
        <line x1="72" y1="36" x2="60" y2="60" stroke="#94a3b8" stroke-width="3"/>
        <path d="M72 36 L60 60" stroke="#c8a97e" stroke-width="6" stroke-linecap="round"/>
        <polyline points="60,60 74,48" stroke="#94a3b8" stroke-width="2.5" stroke-linecap="round"/>
        <circle cx="74" cy="48" r="4.5" fill="#c8a97e"/>
        <path d="M60 68 C 68 68, 76 60, 78 50" stroke="#c8a97e" stroke-width="1.5" stroke-dasharray="2 2"/>
        
        <text x="135" y="24" fill="#c8a97e" font-size="10" font-family="monospace" font-weight="bold">БИЦЕПС НА НАКЛОННОЙ</text>
        <text x="135" y="38" fill="#94a3b8" font-size="9" font-family="monospace">Угол скамьи: 45°</text>
        <text x="135" y="52" fill="#64748b" font-size="8" font-family="monospace">Локти отведены назад</text>
        <text x="135" y="66" fill="#10b981" font-size="8" font-family="monospace">Глубокая растяжка длинной головки</text>
        <text x="135" y="80" fill="#94a3b8" font-size="8" font-family="monospace">Супинация в верхней трети</text>
      </svg>
    `;
  }
...
function getExerciseAnatomyInfo(exName) {
  ...
  } else if (n.includes("разгибания рук") || (n.includes("блоке") && n.includes("трицепс")) || n.includes("канат") || n.includes("кикбэк") || n.includes("из-за головы")) {
    info.category = "Трицепс";
    info.equipment = "Гантели / Блок / Скамья";
    info.tier = "Изолирующее";
    info.muscleMatrix = [
  ...
  } else if ((n.includes("наклонн") || n.includes("45°")) && (n.includes("бицепс") || n.includes("гантел"))) {
    info.category = "Бицепс";
    info.equipment = "Гантели / Наклонная скамья 45°";
    info.tier = "Формирующее в растянутой позиции";
    info.muscleMatrix = [
      { name: "Длинная головка бицепса (внешний пик)", percent: 100, role: "Главный агонист" },
      { name: "Короткая головка бицепса", percent: 75, role: "Синергист" },
      { name: "Брахиалис и плечелучевая мышца", percent: 65, role: "Синергист" }
    ];
    info.dos = [
      "Угол наклона скамьи 45–60° (создает максимальное предварительное растяжение волокон).",
      "Локти зафиксированы сзади корпуса и не выносятся вперед при подъеме.",
      "В нижней точке делай паузу 1 сек с глубоким ощущением натяжения бицепса."
    ];
    info.donts = [
      "Не выдвигай локти вперед к груди — это ворует нагрузку передней дельтой.",
      "Не отрывай лопатки и голову от спинки скамьи."
    ];
